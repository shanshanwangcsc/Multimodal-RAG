...
#+OPTIONS: num:nil
#+OPTIONS: ^:{}
#+ATTR_HTML: :style display:block; margin:0 auto; width:10%;
[[file:./multimodal-RAG.jpg]]
...
This repository not only demonstrates the implementation of a multimodal RAG system, but also emphasizes scalability by leveraging Distributed Data Parallel (DDP), particularly for handling large datasets. The overall workflow is shown in the figure above.
